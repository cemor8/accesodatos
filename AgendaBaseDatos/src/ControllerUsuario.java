...
public class ControllerUsuario {
    ...
    /**
     *Método que se encarga de introducir un contacto en la agenda del usuario
     * **/
    public void introducirUsuarioEnAgenda(){
        ...
        try {
            ...
            while (columnasContacto.next()){
                ...
                String tipoDato = columnasContacto.getString("COLUMN_NAME");
                String dato=null;
                if(nombre_columna.equalsIgnoreCase("nombre")){
                    dato = this.devolverString("Introduce el dato para "+nombre_columna+", introduce null para dejar en blanco","^[A-Z][a-z]{2,19}$");
                }else if(nombre_columna.equalsIgnoreCase("apellidos")){
    ...
    public String devolverString(String texto, String patron) {
        ...
        while (stringDevolver == null) {
            ...
            try {
                ...
                if (patron!=null && !validarDatos(patron,stringDevolver)){
